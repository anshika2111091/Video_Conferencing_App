...
const MeetingModel = ({isOpen,onClose,title,className,children,buttonText,handleClick,image,buttonIcon}:MeetingModelProps) => {
  return (
  ...
  <h1 className={cn('text-3xl font-bold leading-[40px]',className)}>{title}</h1>
  {children}
